function(programId,projectIds,verticalIds,startDate,endDate,userId) {
	var criteria = {};
	criteria.$and = [];
	...
	if(userId)
		criteria.$and.push({"ASSIGNED_TO.$id":userId});
	                                                	  ...
	                                                	  $match : criteria
	                                                		  ...
	                                                		  function(data){
	                                                			  ...
	                                                			  /* try {
                                                                                	  var user_name_id= (data['ASSIGNED_TO']['$id'])?data['ASSIGNED_TO']['$id']:null;
                                                                                	  taskObj['USER_NAME']= getUserName(user_name_id);
                                                                                           // taskObj['DUE_DATE']=data['DUE_DATE']['$date'];
	                                                			  ...
	                                                			  //taskObj['USER_NAME']= data['ASSIGNED_TO']['$id'];
